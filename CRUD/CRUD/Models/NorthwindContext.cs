...
public partial class NorthwindContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<OrderDetail>(entity =>
        {
            ...
            entity.Property(e => e.Quantity).HasAnnotation("Relational:DefaultConstraintName", "DF_Order_Details_Quantity");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.ReorderLevel).HasAnnotation("Relational:DefaultConstraintName", "DF_Products_ReorderLevel");
            entity.Property(e => e.SupplierId).HasColumnName("SupplierID");
            entity.Property(e => e.UnitPrice)
                .HasAnnotation("Relational:DefaultConstraintName", "DF_Products_UnitPrice")
                .HasColumnType("money");
            entity.Property(e => e.UnitsInStock).HasAnnotation("Relational:DefaultConstraintName", "DF_Products_UnitsInStock");
